...
use PHPCartzy\Exception\CurlException;
use PHPCartzy\Exception\ResourceRateLimitException;
...
class CurlRequest
{
    ...
    protected static function init($url, $httpHeaders = array())
    {
        ...
        curl_setopt($ch, CURLOPT_USERAGENT, 'PHPCartzy');
    ...
    protected static function processRequest($ch)
    {
        ...
        while (1) {
            ...
            $limitHeader = explode('/', $response->getHeader('X-Cartzy-Shop-Api-Call-Limit'), 2);
